...
def apply_changes(
    ...
    for name, data in brothers.items():
        ...
        loyalty_change = data.get(
            "loyalty_change",
            0
        )


        trust_change = data.get(
            "trust_change",
            0
        )
        ...
        b["loyalty"] += loyalty_change

        b["trust"] += trust_change
    ...
    if love:
        ...
        affection_change = love_data.get(
            "affection_change",
            0
        )


        trust_change = love_data.get(
            "trust_change",
            0
        )
