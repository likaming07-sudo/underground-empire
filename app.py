...
choices 必須配合 next_month_story。

例如 next_month_story 是：
...
if state["phase"] == "playing":
    ...
    # 注意：
    # 不使用 key="action_text"
    # 避免之後修改 session_state 造成 Streamlit APIException
    with st.form(
        "action_form",
    ...
    if submitted:
        ...
        # 只清除 selected_action
        #
        # 不碰 text_area 的 session_state
        # 因為這個版本根本沒有使用 key="action_text"
        # ====================================================
