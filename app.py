...
def load_game_file(uploaded_file):
    ...
    try:
        ...
        if "suggested_actions" not in game:
...
if state["current_story"] is None:
    ...
    with st.spinner(
        ...
        try:
            ...
            # 保證至少有三個選項
            if len(state["suggested_actions"]) < 3:
...
if submitted:
    ...
    if selected_action in ["1", "2", "3"]:
        ...
        selected_action = suggestions[index]
